  ...
  return (
    <Label
      className={cn(
        ...
        "has-[>[data-slot=field]]:squircle-3xl has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border [&>*]:data-[slot=field]:p-4",
